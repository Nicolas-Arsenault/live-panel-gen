                    ...
                    <div className="fixed w-100 p-16 border-4 border-[#1c1d20] bg-[#111214] text-white rounded-xl">
                        ...
                        <div className="flex flex-col gap-2">
                            <form onSubmit={handleChangePassword}>
                                ...
                                <input className="border border-[#202225] bg-[#111214] p-3 mb-3 text-white font-sans rounded-md focus:outline-none focus:border-[#4dff00]" value={username} placeholder="Your New Username" type="password" />
